...
## Required Image: `midnight-sanctuary.jpg`
...
2. Optimize/compress to under 400KB
3. Save as `midnight-sanctuary.jpg` in this directory
4. The homepage will automatically use it when Midnight Prism theme is active
