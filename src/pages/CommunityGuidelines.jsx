...
/**
 * STEP 2: Community Guidelines (Merged)
 * 
 * Combines:
 * - Community.jsx (full content)
 * - AcceptableUse.jsx (technical misuse section)
 * 
  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-content">
        ...
        <section className="legal-section">
          <h2>10. Network & Technical Misuse</h2>
          <p>
            <strong>You may NOT:</strong>
          </p>
          <ul>
            <li>Attempt to hack the platform or gain unauthorized access</li>
            <li>Scrape large amounts of data or use automated bots</li>
            <li>Attack our servers or infrastructure (DDoS, etc.)</li>
            <li>Attempt to bypass security measures or access controls</li>
            <li>Distribute malware, viruses, or phishing links</li>
            <li>Reverse engineer or decompile our software</li>
          </ul>
          <p>
            <strong>Misleading Behavior:</strong>
          </p>
          <ul>
            <li>Creating fake accounts or impersonating others</li>
            <li>Catfishing or deceptive relationships</li>
            <li>Fraudulent fundraising or scams</li>
            <li>Spreading misinformation or coordinated manipulation</li>
          </ul>
          <p>
            Technical misuse and deceptive behavior undermine trust and safety. Violations may result in immediate account suspension or permanent ban.
          </p>
        </section>
        ...
        <section className="legal-section">
          ...
          <p>
            See our <Link to="/safety-moderation" className="legal-link">Safety & Moderation</Link> page for more resources and support.
          </p>
        </section>

        <section className="legal-section">
          <h2>12. How We Respond to Violations</h2>
          <p>
